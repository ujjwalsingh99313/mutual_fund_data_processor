...
@app.post("/cam/wbr2c", response_model=StatusResponse, tags=["CAMS"])
...
@app.post("/cam/wbr22", response_model=StatusResponse, tags=["CAMS"])
...
@app.post("/cam/wbr9", response_model=StatusResponse, tags=["CAMS"])
...
@app.post("/cam/wbr2", response_model=StatusResponse, tags=["CAMS"])
...
@app.post("/cam/wbr49", response_model=StatusResponse, tags=["CAMS"])
...
@app.post("/cam/wbr77", response_model=StatusResponse, tags=["CAMS"])
...
@app.post("/cam/wbr5", response_model=StatusResponse, tags=["CAMS"])
